 ...
 * are the point of this file: "Cash Rewards" and "Harbor Cash Visa
...
describe('inferAccountKind', () => {
  it('classifies deposit accounts from their names', () => {
    ...
    expect(inferAccountKind('BASIC CHECKING (0000)', 'Second Credit Union')).toBe('checking');
  ...
  it('classifies cards by network and product name', () => {
    expect(inferAccountKind('VISA SIGNATURE (0000)', 'Second Credit Union')).toBe('credit');
