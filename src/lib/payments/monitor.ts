...
async function runInvoiceMonitorCycle(supabase: any, now: Date): Promise<InvoiceMonitorStats> {
...
async function runInvoiceSchedulerCycle(supabase: any, now: Date): Promise<InvoiceSchedulerStats> {
